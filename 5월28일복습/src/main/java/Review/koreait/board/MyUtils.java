...
import Review.koreait.board.user.UserEntitiy;
...
public class MyUtils {
	...
	public static UserEntitiy getLoginUser(HttpServletRequest req) {
		if(req == null) { return null; } 
		HttpSession hs = req.getSession();
		return (UserEntitiy) hs.getAttribute("loginUser");
	}
